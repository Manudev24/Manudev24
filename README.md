<h1 align="center">Manuel Hernandez</h1>

<p align="center">
  <em>Systems Engineer · Software Developer · Mobile Focused</em>
</p>

<p align="center">
  Systems engineer with a strong focus on software development. Full Stack developer specialized in mobile, building cross-platform apps with Flutter for both Android and iOS. On the web side, I work with Next.js, React, and TypeScript to deliver fast, modern interfaces. My backend stack is built around Go and PostgreSQL, where I prioritize clean architecture, performance, and scalable APIs. I'm passionate about crafting polished digital products from end to end — from pixel-perfect UIs to well-structured backend services. Self-taught at heart, always learning, always shipping.
</p>
